export const costControlFeatures = [
  ...
  },
  {
    ...
    kicker:
      "Smart recommendations that understand your infrastructure context.",
    points: [
      {
        heading: "Workload-Aware Recommendations",
        description:
          "Get optimization suggestions that consider your application's performance requirements and SLAs.",
      },
      {
        heading: "Risk Assessment",
        description:
          "Every recommendation includes risk analysis so you can make informed decisions.",
      },
      {
        heading: "Savings Projections",
        description:
          "See estimated savings before implementing changes — prioritize high-impact, low-risk optimizations first.",
      },
    ],
    outcome:
  ...
  },
  {
    ...
    tabLabel: "Workflow Management",
    badge: "Workflow Automation",
    title: "Workflow Management That Drives Action",
    kicker: "Turn insights into completed savings with tracked accountability.",
    points: [
      {
