...
import { pricingFallback, type LocalPricing } from "@/features/pricing/data";

type PricingContentProps = {
  data?: LocalPricing | null;
};

export default function PricingContent({ data }: PricingContentProps) {
  const [submitted, setSubmitted] = useState(false);
  const content = data || pricingFallback;
