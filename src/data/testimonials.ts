...
export const logoRowFallback: { alt: string; src: string }[] = [
  ...
  { alt: 'SAFE', src: '/assets/images/testimonials/verified-safe-security-logo-2.png' },
  {alt: 'Innovaccer', src: '/assets/images/testimonials/innovaccer.png'},
  { alt: 'Xactly', src: '/assets/images/testimonials/Xactly.png' },
  { alt: 'HDFC Life', src: '/assets/images/testimonials/HDFC-Life-Logo.png' },
]
